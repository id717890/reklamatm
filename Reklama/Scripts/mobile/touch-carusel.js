...
(function (f) {
    function q(b, c) {
        ...
        "ontouchstart" in window ? (this.hasTouch = !0, this._c = "touchstart.rs", this._d = "touchmove.rs", this._e = "touchend.rs", this._x = this.settings.baseTouchFriction) : (this.hasTouch =
            !1, this._x = this.settings.baseMouseFriction, this.settings.dragUsingMouse ? (this._c = "mousedown.rs", this._d = "mousemove.rs", this._e = "mouseup.rs", this._y, this._z, a = d._o, a.msie || a.opera ? this._y = this._z = "move" : a.mozilla && (this._y = "-moz-grab", this._z = "-moz-grabbing"), this._a1()) : this._n.addClass("auto-cursor"));
        if ((this.hasTouch || this.settings.useWebkit3d) && "WebKitCSSMatrix" in window && "m11" in new WebKitCSSMatrix) this._l.css({ "-webkit-transform-origin": "0 0", "-webkit-transform": "translateZ(0)" }), this._w = !0;
        ...
        g.each(function (b) {
            ...
            } else h.find("a").bind("click.touchcarousel", function (a) { if (d._q) return a.preventDefault(), !1; });
        ...
        if (this.settings.pagingNav) {
            if (this._j1 = this.settings.snapToItems = !0, this._k1 = Math.ceil(this.numItems / this._i1), this._l1 = 0, this.settings.pagingNavControls) {
                ...
                for (e = 1; e <= this._k1; e++)
                    a = f('<a class="tc-paging-item" href="#">' + e + "</a>").data("tc-id", e), e ===
        ...
        f(window).bind(this._q1, function () {
            l && clearTimeout(l);
            l = setTimeout(function () { d.updateCarouselSize(!1); }, 100);
        });
        ...
        this._n.bind(this._c, function (a) { d._w1(a); });
        ...
        this.settings.keyboardNav && f(document).bind("keydown.touchcarousel", function (a) { d._u || (37 === a.keyCode ? d.prev() : 39 === a.keyCode && d.next()); });
    ...
    q.prototype = {
        ...
        next: function (b) {
            var c = this._c2(), a = this._d2(c).index;
        ...
        getCurrentId: function () { return this._d2(this._c2()).index; },
        setXPos: function (b, c) { c ? this._t1[this._b1] = this._c1 + b + this._d1 : this._m[this._b1] = this._c1 + b + this._d1; },
        ...
        updateCarouselSize: function (b) {
            ...
            if (this.settings.scrollToLast) {
                ...
                if (this._j1) {
                    ...
                    if (0 < a) for (a = this.numItems - a; a < this.numItems; a++) c += this.items[a].width;
            ...
            this.settings.scrollbar && (c = Math.round(this._r1.width() / (this._h1 / this.carouselWidth)), this.scrollbarJQ.css("width", c), this._u1 = this._r1.width() -
                c);
            if (!this.settings.scrollToLast) {
        ...
        animateTo: function (b,
            ...
            this._e2();
            var h = this, n = this.settings.scrollbar, l = h._b1, j = h._c1, m = h._d1, q = { containerPos: this.endPos }, k = { containerPos: b }, v = { containerPos: d };
            d = e ? d : b;
            var s = h._m;
            h._b = !0;
            if (n) {
        ...
        _b2: function (b) { this._j1 && (this._l1 = b = this._h2(b), this.settings.pagingNavControls && (this._n1.removeClass("current"), this._n1.eq(b).addClass("current"))); },
        _h2: function (b) {
            for (var c =
                         this._i1,
                a = 0; a < this._k1; a++) if (b >= a * c && b < a * c + c) return a;
            return 0 > b ? 0 : b >= this._k1 ? this._k1 - 1 : !1;
        },
        _i2: function () { this.settings.loopItems || (this._e1 ? (this._e1 = !1, this.arrowLeft.removeClass("disabled")) : this._f1 && (this._f1 = !1, this.arrowRight.removeClass("disabled"))); },
        _o1: function () { !this._e1 && !this.settings.loopItems && (this._e1 = !0, this.arrowLeft.addClass("disabled"), this._f1 && (this._f1 = !1, this.arrowRight.removeClass("disabled"))); },
        _j2: function () {
        ...
        _d2: function (b) {
            b = -b;
            for (var c, a = 0; a < this.numItems; a++) if (c = this.items[a], b >= c.posX && b < c.posX + c.width) return c;
            return -1;
        },
        _a2: function () { this.autoplay && this.wasAutoplayRunning && (this._x1 || this._z1(), this.wasAutoplayRunning = !1); },
        _g2: function () {
            var b = this;
            this._v1 = !1;
            this._s1 && clearTimeout(this._s1);
            this._s1 = setTimeout(function () { b.scrollbarJQ.animate({ opacity: 0 }, 150, "linear"); }, 450);
        },
        _f2: function () {
            this._v1 = !0;
            this._s1 && clearTimeout(this._s1);
        ...
        _e2: function () { this._p && this._p.stop(); },
        _z1: function () {
            if (this.autoplay) {
                var b = this;
                this.autoplayTimer || (this.autoplayTimer = setInterval(function () { !b._k2 && !b._b && b.next(!0); }, this.settings.autoplayDelay));
            }
        },
        _y1: function () { this.autoplayTimer && (clearInterval(this.autoplayTimer), this.autoplayTimer = ""); },
        _c2: function (b) {
        ...
        _w1: function (b) {
            if (!this._k2) {
                ...
                this._k2 = !0;
                var a = this;
                this._w && a._l.css({ "-webkit-transition-duration": "0", "-webkit-transition-property": "none" });
                f(document).bind(this._d, function (b) { a._m2(b); });
        ...
        _m2: function (b) {
            var c = b.timeStamp || (new Date).getTime(), a;
            if (this.hasTouch) {
                if (this._a) return !1;
        ...
        _n2: function (b) {
            if (this._k2) {
                ...
                if (this.settings.snapToItems) {
                    this.autoplay && this.settings.autoplayStopAtAction && this.stopAutoplay();
                    var a = Boolean(0 < this._r - this._s), e = d(this._c2()), g = this._d2(e).index;
                    ...
                    d = 0, 2 >= b ? (e = 3.5 * this._x, d = 0) : 2 < b && 3 >= b ? (e = 4 * this._x, d = 200) : 3 < b && (d = 300, 4 < b && (b = 4,
        ...
        _a1: function () { this._y ? this._n.css("cursor", this._y) : (this._n.removeClass("grabbing-cursor"), this._n.addClass("grab-cursor")); },
        _l2: function () {
            this._z ?
    ...
    f.extend(jQuery.easing, { easeInOutSine: function (b, c, a, e, d) { return -e / 2 * (Math.cos(Math.PI * c / d) - 1) + a; }, easeOutSine: function (b, c, a, e, d) { return e * Math.sin(c / d * (Math.PI / 2)) + a; }, easeOutCubic: function (b, c, a, e, d) { return e * ((c = c / d - 1) * c * c + 1) + a; } });
})(jQuery);
(function () {
    if (navigator.userAgent.match(/OS 6(_\d)+/i) && void 0 === window.getTimeouts) {
        var f = {},
            ...
            d = function (a, d, e, g) {
                if (e) {
                    ...
                    var m = (new Date).getTime() + d, w = g || !1, k = w ? q : f;
                    j = e + "" + m;
                    k[j] = {};
                    k[j].loop = !0;
                    k[j].callback = a;
        ...
        window.getTimeouts = function () { return { timeouts: f, intervals: q }; };
        window.setTimeout = function (a, b) { return d(a, b, !0); };
        window.setInterval = function (a, b) { return d(a, b, !0, !0); };
        window.clearTimeout = function (a) { return g(a); };
